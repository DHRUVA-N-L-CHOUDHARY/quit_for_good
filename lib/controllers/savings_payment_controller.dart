...
class SavingsPaymentController extends GetxController
{
  Future<dynamic> addUserInfo(SavingsPaymentModel customerDetails) {
    print("djflksd");
    return FirebaseFirestore.instance
        .collection('users').doc(FirebaseAuth.instance.currentUser!.uid).collection("savings").doc(customerDetails.trsid)
